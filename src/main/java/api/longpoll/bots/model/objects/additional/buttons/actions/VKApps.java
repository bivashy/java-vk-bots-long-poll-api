 ...
 */
public class VKApps extends ButtonAction {
    /**
    ...
    public VKApps(int appId, int ownerId, String label, String hash) {
        this(appId, ownerId, label, hash, null);
    }

    public VKApps(int appId, int ownerId, String label, String hash, JsonElement payload) {
