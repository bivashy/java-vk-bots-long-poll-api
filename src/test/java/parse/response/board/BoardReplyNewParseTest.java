...
public class BoardReplyNewParseTest extends AbstractParseTest {
	...
	public void test1_boardReplyNew() throws IOException {
		...
		Assert.assertEquals(Integer.valueOf(2635), updateResponse.getTs());
		...
		Assert.assertEquals("board_post_new", update.getType());
		Assert.assertEquals(Integer.valueOf(168975658), update.getGroupId());
		Assert.assertEquals("a46c51d058490718d21a1db87a8f88946410409e", update.getEventId());
