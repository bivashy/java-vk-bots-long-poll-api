...
public class WallCommentNewParseTest {
    @Test
    void wallReplyNew() {
        Update event = ParseUtil.getFirstEvent("json/response/wall_reply_new/wall_reply_new_sample_5_110.json");
        assertEquals(Update.Type.WALL_REPLY_NEW, event.getType());
