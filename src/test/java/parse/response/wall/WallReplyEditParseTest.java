...
public class WallReplyEditParseTest extends AbstractParseTest {
	@Test
	public void test1_wallReplyEdit() throws IOException {
		...
		Assert.assertEquals(Integer.valueOf(2632), updateResponse.getTs());
		...
		Assert.assertEquals("wall_reply_edit", update.getType());
		Assert.assertEquals(Integer.valueOf(168975658), update.getGroupId());
		Assert.assertEquals("2723997e68891a0c9a14418a39b89d8a6a685418", update.getEventId());
