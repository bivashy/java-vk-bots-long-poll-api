...
public class PhotoCommentNewParseTest extends AbstractParseTest {
	...
	public void test1_messageEdit() throws IOException {
		...
		Assert.assertEquals(Integer.valueOf(2613), updateResponse.getTs());
		...
		Assert.assertEquals("photo_comment_new", update.getType());
		Assert.assertEquals(Integer.valueOf(168975658), update.getGroupId());
		Assert.assertEquals("ca8ad9aa67d5e898a512df3952e653c4e2ad8e3d", update.getEventId());
